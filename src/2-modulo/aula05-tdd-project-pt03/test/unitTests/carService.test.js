...
describe('Carservice Suit Tests', () => {
    ...
    it('should chose the first id from carId in carCategory', () => {
    ...
    it('given a carCategory, customer and numberOfDays it should calculate final amout in real', async () => {
        ...
        const resuilt = carService.calculateFinalPrice(customer, carCategory, numberOfDays)

        expect(resuilt).to.be.deep.equal(expected)
    })
